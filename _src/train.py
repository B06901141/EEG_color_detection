...
if __name__ == "__main__":
    ...
    data_train, data_val = splitData(data_train, testNum = 1)
    ...
    input_ = keras.layers.Input(shape=(512, 5))
    output = input_
    ...
    #output = keras.layers.Dropout(0.7)(output)
    #output = keras.layers.CuDNNLSTM(50, return_sequences=True)(output)
    #output = keras.layers.Dropout(0.7)(output)
    #output = keras.layers.CuDNNLSTM(50, return_sequences=True)(output)
    #output = keras.layers.Dropout(0.7)(output)
    ...
    model.fit(x_train,y_train,validation_data = (x_val,y_val), callbacks=[checkpoint], epochs = 20000)
